...
USTRUCT()
struct SMEDITOR_API FSMGraphSchemaAction_NewNode : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY()

public:
	FSMGraphSchemaAction_NewNode(): NodeTemplate(nullptr), NodeClass(nullptr) {}
...
USTRUCT()
struct SMEDITOR_API FSMGraphSchemaAction_NewStateMachineReferenceNode : public FSMGraphSchemaAction_NewNode
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct SMEDITOR_API FSMGraphSchemaAction_NewComment : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();
...
UCLASS()
class SMEDITOR_API USMGraphSchema : public UEdGraphSchema
{
