...
UCLASS()
class SMEDITOR_API USMBlueprintGeneratedClass : public UBlueprintGeneratedClass
{
...
UCLASS()
class SMEDITOR_API USMNodeBlueprintGeneratedClass : public UBlueprintGeneratedClass
{
	GENERATED_UCLASS_BODY()
