...
void FSMEditorStyle::SetIcons()
{
	...
	// Graph Node Icons.
	StyleSetInstance->Set("SMGraph.StateMachineReference_16x", new IMAGE_BRUSH(TEXT("Icons/icon_Blueprint_StateMachine_Reference_16x"), Icon16x16));
	StyleSetInstance->Set("SMGraph.Clock", new IMAGE_BRUSH(TEXT("Icons/Clock_16"), Icon16x16));
