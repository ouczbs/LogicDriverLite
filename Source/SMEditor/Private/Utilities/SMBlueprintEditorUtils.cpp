...
USMGraphK2* FSMBlueprintEditorUtils::GetTopLevelStateMachineGraph(UBlueprint* Blueprint)
{
	...
	auto ptr = Blueprint->UbergraphPages.FindByPredicate([&](UEdGraph* Graph)
		{
...
void FSMBlueprintEditorUtils::CreateGraphsForNewBlueprint(USMBlueprint* Blueprint)
{
