 ...
 */
class ISMEditorModule : public IModuleInterface
{
...
public:
	 ...
	 */
	static ISMEditorModule& Get()
	{
		return FModuleManager::LoadModuleChecked< ISMEditorModule >( "SMEditor" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "SMEditor" );
	}
