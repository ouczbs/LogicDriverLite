...
//#pragma region Node Locator Helpers
	/**
...
//#pragma endregion
	...
	const TArray<FGuid>& GetReplicatedStates() const { return R_ActiveStates; }
	...
	/** Notifies this instance there is a server instance. */
	void SetServerInstance(TScriptInterface<ISMStateMachineNetworkedInterface> Server);
...
protected:
	...
	UPROPERTY(meta = (BlueprintBaseOnly, DisplayName = "Node Class"))
