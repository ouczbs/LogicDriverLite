	...
	bool FConduitTest::RunTest(const FString& Parameters)
{
	...
	NextConduitNode->GetNodeTemplateAs<USMConduitInstance>()->bCanEvaluate = false;
	int32 IterationsRan;
	...
	// Restore evaluation.
	NextConduitNode->GetNodeTemplateAs<USMConduitInstance>()->bCanEvaluate = true;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FParallelStatesTest, "SMTests.ParallelStates", EAutomationTestFlags::ApplicationContextMask |
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter | EAutomationTestFlags::Disabled)
